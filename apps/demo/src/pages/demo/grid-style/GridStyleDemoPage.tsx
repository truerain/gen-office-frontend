  ...
  const columns = useMemo<ColumnDef<DemoRow, any>[]>(
    () => [
      ...
      },
      {
        ...
        header: '실적/계획',
        columns: [
          { accessorKey: '2022', header: '2022', size: 100, meta: { align: 'right', mono: true, format: 'triangleNumber' as any }, cell: ({ column, getValue }) => renderByFormat(column.columnDef.meta?.format, getValue()) },
          { accessorKey: '2023', header: '2023', size: 100, meta: { align: 'right', mono: true, format: 'triangleNumber' as any }, cell: ({ column, getValue }) => renderByFormat(column.columnDef.meta?.format, getValue()) },
          ...
          { accessorKey: '2026', header: '2026', size: 300, meta: { align: 'right', mono: true, format: 'triangleNumber' as any }, cell: ({ column, getValue }) => renderByFormat(column.columnDef.meta?.format, getValue()) },
          { accessorKey: '2026Plan', header: '2026계획', size: 120, meta: { align: 'right', mono: true, format: 'triangleNumber' as any }, cell: ({ column, getValue }) => renderByFormat(column.columnDef.meta?.format, getValue()) },
