...
Gate 4.1 follow-up also needs an editor-opening policy for surfaces that should open immediately after edit entry, such as dropdown, datepicker, popover, and modal editors.
...
Gate 4.1 should extend the effective editor policy surface so built-in and custom editors can react to:
